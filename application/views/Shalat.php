...
<body class="g-sidenav-show  bg-gray-100">
    <?php $this->load->view('Aset/Aside3') ?>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Data Absen Shalat / COMING SOON</h6>
                        </div>
                                ...
                                <table class="table table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="30" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Bulan November</th>
                                        </tr>
                                        <tr>
                                            <?php
                                            $count = 0;
